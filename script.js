...
function scheduleGlitch() {
  const interval = (Math.random() * 60000 + 90000); // 90-150s base, adjust as needed
  setTimeout(() => {
    triggerGlitch();
    scheduleGlitch();
  }, interval);
